...
export function buildDynamicLeadBlock(lead = {}, extras = {}) {
  ...
  return [
    ...
    "9. Коммерческие решения принимает только живой менеджер. Не подтверждай цену, скидку, объём «под бюджет клиента» и не придумывай пакеты. Если клиент назвал свою сумму, просит дешевле или нестандартные условия — manager_event=decision_required, клиенту ответь нейтрально без обещаний.",
    "",
    "=== INTERNAL LEAD DATA ===",
